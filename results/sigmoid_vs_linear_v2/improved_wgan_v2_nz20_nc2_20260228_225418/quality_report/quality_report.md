...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.034016 |
| Mean relative difference | 0.5449 (54.49%) |
| Variance ratio (gen/real) | 0.7424 |
| Variance absolute difference | 0.011426 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.059181 |
| σ dimensions mean | 0.071394 |
| μ dimensions mean | 0.046968 |
...
|--------|-------|
| Total MMD | 0.058669 |
| σ component | 0.020296 |
| μ component | 0.038373 |
...
| Mean |Z| | 3.235507e+01 |
| Std |Z| | 1.274168e+01 |
| Impedance real range | [2.515678e-01, 4.486394e+01] |
| Impedance imag range | [-1.780435e+01, 4.221034e+00] |
| Reference |Z| (real data) | 6.135537e+01 |
| Amplitude relative error | 0.4727 (47.27%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.012469 | 0.053958 |
| 0.050 | 0.055678 | 0.179512 |
| 0.100 | 0.137024 | 0.459001 |
| 0.200 | 0.268891 | 1.087006 |
| 0.500 | 0.631280 | 2.569153 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 0.6596 |
