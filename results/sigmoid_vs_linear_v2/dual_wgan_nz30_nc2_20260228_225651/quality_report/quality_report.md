...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.030904 |
| Mean relative difference | 0.5324 (53.24%) |
| Variance ratio (gen/real) | 1.0741 |
| Variance absolute difference | 0.017217 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.063799 |
| σ dimensions mean | 0.068690 |
| μ dimensions mean | 0.058908 |
...
|--------|-------|
| Total MMD | 0.121692 |
| σ component | 0.049160 |
| μ component | 0.072532 |
...
| Mean |Z| | 6.653637e+01 |
| Std |Z| | 2.853269e+01 |
| Impedance real range | [2.994897e+00, 5.233670e+01] |
| Impedance imag range | [2.690028e+01, 8.477398e+01] |
| Reference |Z| (real data) | 6.135537e+01 |
| Amplitude relative error | 0.0844 (8.44%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.016107 | 0.072762 |
| 0.050 | 0.089849 | 0.465473 |
| 0.100 | 0.150273 | 0.602781 |
| 0.200 | 0.375173 | 1.366169 |
| 0.500 | 0.855890 | 2.611829 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 0.8877 |
