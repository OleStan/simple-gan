...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.032625 |
| Mean relative difference | 0.4524 (45.24%) |
| Variance ratio (gen/real) | 1.0832 |
| Variance absolute difference | 0.015975 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.055548 |
| σ dimensions mean | 0.049241 |
| μ dimensions mean | 0.061854 |
...
|--------|-------|
| Total MMD | 0.079651 |
| σ component | 0.022749 |
| μ component | 0.056902 |
...
| Mean |Z| | 4.824298e+01 |
| Std |Z| | 1.634146e+01 |
| Impedance real range | [-1.325480e-01, 4.693420e+01] |
| Impedance imag range | [1.104683e+01, 6.935952e+01] |
| Reference |Z| (real data) | 6.135537e+01 |
| Amplitude relative error | 0.2137 (21.37%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.014722 | 0.036558 |
| 0.050 | 0.064513 | 0.359137 |
| 0.100 | 0.140633 | 0.520152 |
| 0.200 | 0.263263 | 1.106099 |
| 0.500 | 0.562744 | 1.670794 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 1.1155 |
