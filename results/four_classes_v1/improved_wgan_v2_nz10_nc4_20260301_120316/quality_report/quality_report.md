...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.027642 |
| Mean relative difference | 0.9063 (90.63%) |
| Variance ratio (gen/real) | 0.9841 |
| Variance absolute difference | 0.020271 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.057410 |
| σ dimensions mean | 0.053519 |
| μ dimensions mean | 0.061300 |
...
|--------|-------|
| Total MMD | 0.015294 |
| σ component | 0.002500 |
| μ component | 0.012794 |
...
| Mean |Z| | 3.658824e+01 |
| Std |Z| | 2.182145e+01 |
| Impedance real range | [-3.327710e+00, 1.278608e+01] |
| Impedance imag range | [1.038279e+01, 7.142162e+01] |
| Reference |Z| (real data) | 4.694098e+01 |
| Amplitude relative error | 0.2205 (22.05%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.000463 | 0.000714 |
| 0.050 | 0.001106 | 0.004591 |
| 0.100 | 0.002218 | 0.007434 |
| 0.200 | 0.003937 | 0.015034 |
| 0.500 | 0.009100 | 0.017865 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 0.0151 |
