...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.024250 |
| Mean relative difference | 0.8648 (86.48%) |
| Variance ratio (gen/real) | 0.9867 |
| Variance absolute difference | 0.017942 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.046317 |
| σ dimensions mean | 0.047629 |
| μ dimensions mean | 0.045006 |
...
|--------|-------|
| Total MMD | 0.010651 |
| σ component | 0.005511 |
| μ component | 0.005140 |
...
| Mean |Z| | 5.756472e+01 |
| Std |Z| | 3.442449e+01 |
| Impedance real range | [-7.290408e+00, 2.618541e+01] |
| Impedance imag range | [2.503671e+00, 1.032438e+02] |
| Reference |Z| (real data) | 4.694098e+01 |
| Amplitude relative error | 0.2263 (22.63%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.001058 | 0.003806 |
| 0.050 | 0.004746 | 0.013423 |
| 0.100 | 0.011125 | 0.027335 |
| 0.200 | 0.017419 | 0.056598 |
| 0.500 | 0.045668 | 0.212189 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 0.0533 |
