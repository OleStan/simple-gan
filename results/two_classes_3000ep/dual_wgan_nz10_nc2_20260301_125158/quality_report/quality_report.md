...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.033504 |
| Mean relative difference | 0.5063 (50.63%) |
| Variance ratio (gen/real) | 0.8767 |
| Variance absolute difference | 0.011641 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.045541 |
| σ dimensions mean | 0.037195 |
| μ dimensions mean | 0.053888 |
...
|--------|-------|
| Total MMD | 0.058687 |
| σ component | 0.006993 |
| μ component | 0.051694 |
...
| Mean |Z| | 7.256668e+01 |
| Std |Z| | 4.177485e+01 |
| Impedance real range | [1.293520e+00, 5.584537e+01] |
| Impedance imag range | [1.186768e+01, 1.407679e+02] |
| Reference |Z| (real data) | 5.404348e+01 |
| Amplitude relative error | 0.3427 (34.27%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.018597 | 0.062628 |
| 0.050 | 0.085692 | 0.331355 |
| 0.100 | 0.178532 | 0.711563 |
| 0.200 | 0.358573 | 1.086728 |
| 0.500 | 0.837822 | 3.382150 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 1.4696 |
