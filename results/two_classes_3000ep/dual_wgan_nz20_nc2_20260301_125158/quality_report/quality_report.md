...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.028668 |
| Mean relative difference | 0.4202 (42.02%) |
| Variance ratio (gen/real) | 1.0669 |
| Variance absolute difference | 0.019287 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.053175 |
| σ dimensions mean | 0.054773 |
| μ dimensions mean | 0.051578 |
...
|--------|-------|
| Total MMD | 0.079873 |
| σ component | 0.022808 |
| μ component | 0.057065 |
...
| Mean |Z| | 1.139060e+02 |
| Std |Z| | 8.618700e+01 |
| Impedance real range | [-5.016298e+00, 4.691956e+01] |
| Impedance imag range | [8.235587e-01, 2.220601e+02] |
| Reference |Z| (real data) | 5.404348e+01 |
| Amplitude relative error | 1.1077 (110.77%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.013065 | 0.053298 |
| 0.050 | 0.080536 | 0.283247 |
| 0.100 | 0.138255 | 0.436874 |
| 0.200 | 0.295418 | 0.784426 |
| 0.500 | 0.682104 | 2.443932 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 0.7686 |
