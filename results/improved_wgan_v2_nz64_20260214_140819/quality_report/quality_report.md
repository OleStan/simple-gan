...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.014035 |
| Mean relative difference | 0.0381 (3.81%) |
| Variance ratio (gen/real) | 0.7821 |
| Variance absolute difference | 0.002183 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.019427 |
| σ dimensions mean | 0.023562 |
| μ dimensions mean | 0.015293 |
...
|--------|-------|
| Total MMD | 0.061962 |
| σ component | 0.022216 |
| μ component | 0.039746 |
...
| Mean |Z| | 1.279072e+00 |
| Std |Z| | 1.174188e+00 |
| Impedance real range | [-5.289722e-01, 1.628443e-01] |
| Impedance imag range | [-3.762973e+00, 2.730284e-01] |
| Reference |Z| (real data) | 3.324762e-01 |
| Amplitude relative error | 2.8471 (284.71%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.009185 | 0.036539 |
| 0.050 | 0.045930 | 0.173326 |
| 0.100 | 0.093211 | 0.358535 |
| 0.200 | 0.178358 | 0.520580 |
| 0.500 | 0.471555 | 1.319081 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 0.3061 |
