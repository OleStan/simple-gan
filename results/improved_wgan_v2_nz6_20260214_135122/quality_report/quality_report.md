...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.032957 |
| Mean relative difference | 0.1525 (15.25%) |
| Variance ratio (gen/real) | 0.8321 |
| Variance absolute difference | 0.002837 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.036902 |
| σ dimensions mean | 0.034744 |
| μ dimensions mean | 0.039061 |
...
|--------|-------|
| Total MMD | 0.213862 |
| σ component | 0.067961 |
| μ component | 0.145901 |
...
| Mean |Z| | 1.168126e+00 |
| Std |Z| | 6.065461e-01 |
| Impedance real range | [-1.059099e+00, 6.931828e-02] |
| Impedance imag range | [-2.623878e+00, 1.425296e+00] |
| Reference |Z| (real data) | 3.324762e-01 |
| Amplitude relative error | 2.5134 (251.34%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.008902 | 0.036636 |
| 0.050 | 0.046512 | 0.178846 |
| 0.100 | 0.093520 | 0.346222 |
| 0.200 | 0.182018 | 0.558066 |
| 0.500 | 0.431606 | 1.589603 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 0.9187 |
