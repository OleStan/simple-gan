...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.016888 |
| Mean relative difference | 0.0713 (7.13%) |
| Variance ratio (gen/real) | 0.6736 |
| Variance absolute difference | 0.002357 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.023022 |
| σ dimensions mean | 0.027523 |
| μ dimensions mean | 0.018520 |
...
|--------|-------|
| Total MMD | 0.116518 |
| σ component | 0.052712 |
| μ component | 0.063807 |
...
| Mean |Z| | 9.335225e-01 |
| Std |Z| | 5.741005e-01 |
| Impedance real range | [-5.508754e-01, 1.587358e-01] |
| Impedance imag range | [-2.292707e+00, 2.454064e-01] |
| Reference |Z| (real data) | 3.324762e-01 |
| Amplitude relative error | 1.8078 (180.78%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.008251 | 0.033572 |
| 0.050 | 0.040108 | 0.142715 |
| 0.100 | 0.080926 | 0.404676 |
| 0.200 | 0.160097 | 0.661442 |
| 0.500 | 0.415038 | 1.476988 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 0.4169 |
