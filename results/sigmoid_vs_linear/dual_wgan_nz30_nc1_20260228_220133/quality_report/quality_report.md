...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.017046 |
| Mean relative difference | 0.1035 (10.35%) |
| Variance ratio (gen/real) | 0.4900 |
| Variance absolute difference | 0.008279 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.059898 |
| σ dimensions mean | 0.065234 |
| μ dimensions mean | 0.054562 |
...
|--------|-------|
| Total MMD | 0.493763 |
| σ component | 0.194522 |
| μ component | 0.299241 |
...
| Mean |Z| | 8.635362e-01 |
| Std |Z| | 3.582236e-01 |
| Impedance real range | [-7.840290e-01, 4.338165e-01] |
| Impedance imag range | [-1.310475e+00, 9.806929e-01] |
| Reference |Z| (real data) | 3.324762e-01 |
| Amplitude relative error | 1.5973 (159.73%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.006872 | 0.229006 |
| 0.050 | 0.031669 | 0.797991 |
| 0.100 | 0.059442 | 1.169650 |
| 0.200 | 0.085342 | 1.164242 |
| 0.500 | 0.200401 | 1.161517 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 1.3071 |
