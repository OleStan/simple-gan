...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.018038 |
| Mean relative difference | 0.0921 (9.21%) |
| Variance ratio (gen/real) | 0.9854 |
| Variance absolute difference | 0.017611 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.056781 |
| σ dimensions mean | 0.059348 |
| μ dimensions mean | 0.054213 |
...
|--------|-------|
| Total MMD | 0.043234 |
| σ component | 0.019786 |
| μ component | 0.023448 |
...
| Mean |Z| | 1.290939e+01 |
| Std |Z| | 4.757934e+00 |
| Impedance real range | [-6.122088e+00, 1.739048e+01] |
| Impedance imag range | [-2.326039e+01, 3.224358e-01] |
| Reference |Z| (real data) | 2.741033e+01 |
| Amplitude relative error | 0.5290 (52.90%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.023019 | 0.067147 |
| 0.050 | 0.121581 | 0.388735 |
| 0.100 | 0.218472 | 0.595251 |
| 0.200 | 0.412009 | 1.028088 |
| 0.500 | 0.990072 | 2.396091 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 1.0574 |
