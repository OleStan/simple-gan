...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.057661 |
| Mean relative difference | 0.7055 (70.55%) |
| Variance ratio (gen/real) | 0.8989 |
| Variance absolute difference | 0.013573 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.075017 |
| σ dimensions mean | 0.058177 |
| μ dimensions mean | 0.091857 |
...
|--------|-------|
| Total MMD | 0.116677 |
| σ component | 0.036329 |
| μ component | 0.080348 |
...
| Mean |Z| | 5.744473e+01 |
| Std |Z| | 2.938682e+01 |
| Impedance real range | [-2.140591e+00, 1.185937e+01] |
| Impedance imag range | [-9.523773e+01, 3.062323e+01] |
| Reference |Z| (real data) | 2.741033e+01 |
| Amplitude relative error | 1.0957 (109.57%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.022884 | 0.058272 |
| 0.050 | 0.111381 | 0.311132 |
| 0.100 | 0.183782 | 0.535416 |
| 0.200 | 0.457759 | 0.990130 |
| 0.500 | 1.132595 | 2.645521 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 1.8013 |
