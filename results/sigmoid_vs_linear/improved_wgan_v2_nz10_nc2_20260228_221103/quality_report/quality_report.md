...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.042707 |
| Mean relative difference | 0.5411 (54.11%) |
| Variance ratio (gen/real) | 0.8317 |
| Variance absolute difference | 0.016214 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.059538 |
| σ dimensions mean | 0.066725 |
| μ dimensions mean | 0.052352 |
...
|--------|-------|
| Total MMD | 0.035604 |
| σ component | 0.020216 |
| μ component | 0.015388 |
...
| Mean |Z| | 2.076099e+01 |
| Std |Z| | 1.185407e+01 |
| Impedance real range | [-1.843484e+00, 1.128959e+01] |
| Impedance imag range | [-2.251108e+01, 4.714830e+01] |
| Reference |Z| (real data) | 2.741033e+01 |
| Amplitude relative error | 0.2426 (24.26%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.024509 | 0.053144 |
| 0.050 | 0.124390 | 0.357409 |
| 0.100 | 0.248687 | 0.649036 |
| 0.200 | 0.421644 | 1.446578 |
| 0.500 | 1.080941 | 3.232857 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 1.4744 |
