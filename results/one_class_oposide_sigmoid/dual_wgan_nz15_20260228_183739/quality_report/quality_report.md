...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.020833 |
| Mean relative difference | 0.0599 (5.99%) |
| Variance ratio (gen/real) | 1.1107 |
| Variance absolute difference | 0.002535 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.026042 |
| σ dimensions mean | 0.029220 |
| μ dimensions mean | 0.022865 |
...
|--------|-------|
| Total MMD | 0.133696 |
| σ component | 0.053862 |
| μ component | 0.079834 |
...
| Mean |Z| | 2.341585e+00 |
| Std |Z| | 1.194070e+00 |
| Impedance real range | [-2.483784e+00, 7.097127e-01] |
| Impedance imag range | [-3.300952e+00, 2.279011e-01] |
| Reference |Z| (real data) | 3.324762e-01 |
| Amplitude relative error | 6.0429 (604.29%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.020319 | 0.124493 |
| 0.050 | 0.097673 | 0.560198 |
| 0.100 | 0.186763 | 1.402367 |
| 0.200 | 0.370278 | 1.444673 |
| 0.500 | 0.693336 | 2.591547 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 1.8652 |
