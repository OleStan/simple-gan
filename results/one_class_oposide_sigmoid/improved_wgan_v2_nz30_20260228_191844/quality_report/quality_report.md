...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.035406 |
| Mean relative difference | 0.1074 (10.74%) |
| Variance ratio (gen/real) | 1.0293 |
| Variance absolute difference | 0.007466 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.048386 |
| σ dimensions mean | 0.048679 |
| μ dimensions mean | 0.048094 |
...
|--------|-------|
| Total MMD | 0.383054 |
| σ component | 0.096746 |
| μ component | 0.286309 |
...
| Mean |Z| | 6.593423e-01 |
| Std |Z| | 4.363271e-01 |
| Impedance real range | [-1.082563e+00, 4.752136e-01] |
| Impedance imag range | [-1.987785e+00, 9.562314e-01] |
| Reference |Z| (real data) | 3.324762e-01 |
| Amplitude relative error | 0.9831 (98.31%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.013164 | 0.044394 |
| 0.050 | 0.065618 | 0.342766 |
| 0.100 | 0.125414 | 0.475497 |
| 0.200 | 0.251158 | 0.860974 |
| 0.500 | 0.645985 | 2.336957 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 0.6627 |
