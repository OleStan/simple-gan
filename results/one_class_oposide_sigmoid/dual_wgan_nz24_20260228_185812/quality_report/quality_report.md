...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.024363 |
| Mean relative difference | 0.0607 (6.07%) |
| Variance ratio (gen/real) | 0.8500 |
| Variance absolute difference | 0.003684 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.029502 |
| σ dimensions mean | 0.029776 |
| μ dimensions mean | 0.029229 |
...
|--------|-------|
| Total MMD | 0.189604 |
| σ component | 0.058509 |
| μ component | 0.131094 |
...
| Mean |Z| | 1.941789e+00 |
| Std |Z| | 9.194997e-01 |
| Impedance real range | [-1.992480e+00, -3.079509e-01] |
| Impedance imag range | [-9.468143e-01, 3.732143e+00] |
| Reference |Z| (real data) | 3.324762e-01 |
| Amplitude relative error | 4.8404 (484.04%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.013280 | 0.131666 |
| 0.050 | 0.068007 | 0.404669 |
| 0.100 | 0.129640 | 1.184205 |
| 0.200 | 0.277340 | 1.633140 |
| 0.500 | 0.564509 | 2.432707 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 1.1431 |
