...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.007705 |
| Mean relative difference | 0.0246 (2.46%) |
| Variance ratio (gen/real) | 0.8772 |
| Variance absolute difference | 0.001141 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.010900 |
| σ dimensions mean | 0.012761 |
| μ dimensions mean | 0.009040 |
...
|--------|-------|
| Total MMD | 0.021213 |
| σ component | 0.002763 |
| μ component | 0.018450 |
...
| Mean |Z| | 5.649846e-01 |
| Std |Z| | 3.353020e-01 |
| Impedance real range | [-5.723265e-01, 1.418216e-01] |
| Impedance imag range | [-1.235016e+00, 1.256075e-01] |
| Reference |Z| (real data) | 3.324762e-01 |
| Amplitude relative error | 0.6993 (69.93%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.009269 | 0.025116 |
| 0.050 | 0.046082 | 0.176409 |
| 0.100 | 0.089566 | 0.302284 |
| 0.200 | 0.190971 | 0.663458 |
| 0.500 | 0.490769 | 1.357839 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 0.1985 |
