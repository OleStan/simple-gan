...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.020494 |
| Mean relative difference | 0.0898 (8.98%) |
| Variance ratio (gen/real) | 0.8895 |
| Variance absolute difference | 0.001989 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.023612 |
| σ dimensions mean | 0.022788 |
| μ dimensions mean | 0.024436 |
...
|--------|-------|
| Total MMD | 0.125759 |
| σ component | 0.030845 |
| μ component | 0.094913 |
...
| Mean |Z| | 2.016771e+00 |
| Std |Z| | 1.301793e+00 |
| Impedance real range | [-2.682169e-01, 9.225242e-01] |
| Impedance imag range | [-5.304062e+00, 1.234644e+00] |
| Reference |Z| (real data) | 3.324762e-01 |
| Amplitude relative error | 5.0659 (506.59%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.010196 | 0.042931 |
| 0.050 | 0.050052 | 0.176268 |
| 0.100 | 0.097327 | 0.421693 |
| 0.200 | 0.188136 | 0.702915 |
| 0.500 | 0.454908 | 1.327251 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 0.7121 |
