...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.010096 |
| Mean relative difference | 0.0252 (2.52%) |
| Variance ratio (gen/real) | 1.0027 |
| Variance absolute difference | 0.001296 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.014737 |
| σ dimensions mean | 0.013190 |
| μ dimensions mean | 0.016285 |
...
|--------|-------|
| Total MMD | 0.040645 |
| σ component | 0.006524 |
| μ component | 0.034122 |
...
| Mean |Z| | 1.305272e+00 |
| Std |Z| | 6.363097e-01 |
| Impedance real range | [-5.789883e-01, 1.411658e-02] |
| Impedance imag range | [-1.658393e+00, 2.275358e+00] |
| Reference |Z| (real data) | 3.324762e-01 |
| Amplitude relative error | 2.9259 (292.59%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.009146 | 0.032433 |
| 0.050 | 0.045619 | 0.187106 |
| 0.100 | 0.091071 | 0.265286 |
| 0.200 | 0.181708 | 0.534439 |
| 0.500 | 0.456183 | 1.254015 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 0.3314 |
