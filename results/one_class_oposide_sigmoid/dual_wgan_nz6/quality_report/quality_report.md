...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.027051 |
| Mean relative difference | 0.1217 (12.17%) |
| Variance ratio (gen/real) | 1.2318 |
| Variance absolute difference | 0.004492 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.035125 |
| σ dimensions mean | 0.036207 |
| μ dimensions mean | 0.034044 |
...
|--------|-------|
| Total MMD | 0.249800 |
| σ component | 0.095721 |
| μ component | 0.154078 |
...
| Mean |Z| | 2.843154e+00 |
| Std |Z| | 2.550399e+00 |
| Impedance real range | [-8.092132e-01, 6.342574e+00] |
| Impedance imag range | [-7.810624e+00, 9.905495e-01] |
| Reference |Z| (real data) | 3.324762e-01 |
| Amplitude relative error | 7.5515 (755.15%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.028192 | 0.342359 |
| 0.050 | 0.151405 | 1.512541 |
| 0.100 | 0.255902 | 1.898804 |
| 0.200 | 0.464307 | 2.458559 |
| 0.500 | 0.796250 | 2.804925 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 5.9962 |
