...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.019928 |
| Mean relative difference | 0.0720 (7.20%) |
| Variance ratio (gen/real) | 1.2038 |
| Variance absolute difference | 0.002764 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.027049 |
| σ dimensions mean | 0.026788 |
| μ dimensions mean | 0.027310 |
...
|--------|-------|
| Total MMD | 0.145800 |
| σ component | 0.040396 |
| μ component | 0.105404 |
...
| Mean |Z| | 2.407212e+00 |
| Std |Z| | 2.116788e+00 |
| Impedance real range | [-1.664693e+00, 5.123838e-01] |
| Impedance imag range | [-1.508113e+00, 6.283567e+00] |
| Reference |Z| (real data) | 3.324762e-01 |
| Amplitude relative error | 6.2403 (624.03%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.017135 | 0.143068 |
| 0.050 | 0.077954 | 0.483944 |
| 0.100 | 0.163962 | 1.194197 |
| 0.200 | 0.310861 | 1.881013 |
| 0.500 | 0.670432 | 2.482395 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 1.9364 |
