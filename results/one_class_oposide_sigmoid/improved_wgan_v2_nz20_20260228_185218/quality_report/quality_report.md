...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.018454 |
| Mean relative difference | 0.0845 (8.45%) |
| Variance ratio (gen/real) | 0.8052 |
| Variance absolute difference | 0.002040 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.022000 |
| σ dimensions mean | 0.030827 |
| μ dimensions mean | 0.013172 |
...
|--------|-------|
| Total MMD | 0.093191 |
| σ component | 0.062441 |
| μ component | 0.030750 |
...
| Mean |Z| | 8.652688e-01 |
| Std |Z| | 3.943416e-01 |
| Impedance real range | [-4.568164e-01, 2.322992e-01] |
| Impedance imag range | [-3.777183e-01, 1.529972e+00] |
| Reference |Z| (real data) | 3.324762e-01 |
| Amplitude relative error | 1.6025 (160.25%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.008320 | 0.029476 |
| 0.050 | 0.040159 | 0.132021 |
| 0.100 | 0.080819 | 0.259016 |
| 0.200 | 0.154743 | 0.559351 |
| 0.500 | 0.392253 | 1.131483 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 0.4635 |
