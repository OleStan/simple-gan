...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.012869 |
| Mean relative difference | 0.0402 (4.02%) |
| Variance ratio (gen/real) | 0.9392 |
| Variance absolute difference | 0.001154 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.015297 |
| σ dimensions mean | 0.018000 |
| μ dimensions mean | 0.012594 |
...
|--------|-------|
| Total MMD | 0.046600 |
| σ component | 0.017781 |
| μ component | 0.028819 |
...
| Mean |Z| | 1.231238e+00 |
| Std |Z| | 7.217116e-01 |
| Impedance real range | [-2.083752e+00, -3.210818e-01] |
| Impedance imag range | [-3.658451e+00, 9.499068e-01] |
| Reference |Z| (real data) | 3.324762e-01 |
| Amplitude relative error | 2.7032 (270.32%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.009759 | 0.044926 |
| 0.050 | 0.048021 | 0.172652 |
| 0.100 | 0.097381 | 0.362331 |
| 0.200 | 0.193800 | 0.738276 |
| 0.500 | 0.492879 | 1.519526 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 0.5500 |
