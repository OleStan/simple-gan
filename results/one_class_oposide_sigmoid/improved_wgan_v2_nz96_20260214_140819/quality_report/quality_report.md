...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.010330 |
| Mean relative difference | 0.0424 (4.24%) |
| Variance ratio (gen/real) | 0.9409 |
| Variance absolute difference | 0.001166 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.013172 |
| σ dimensions mean | 0.018700 |
| μ dimensions mean | 0.007644 |
...
|--------|-------|
| Total MMD | 0.035206 |
| σ component | 0.018988 |
| μ component | 0.016218 |
...
| Mean |Z| | 5.187762e-01 |
| Std |Z| | 3.346438e-01 |
| Impedance real range | [-9.620490e-01, -2.833440e-02] |
| Impedance imag range | [-9.474104e-01, 3.169210e-01] |
| Reference |Z| (real data) | 3.324762e-01 |
| Amplitude relative error | 0.5603 (56.03%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.008757 | 0.025354 |
| 0.050 | 0.044702 | 0.146395 |
| 0.100 | 0.093138 | 0.380106 |
| 0.200 | 0.178529 | 0.611898 |
| 0.500 | 0.481257 | 1.792677 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 0.2316 |
