...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.021500 |
| Mean relative difference | 0.0552 (5.52%) |
| Variance ratio (gen/real) | 1.0683 |
| Variance absolute difference | 0.003255 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.029486 |
| σ dimensions mean | 0.027215 |
| μ dimensions mean | 0.031757 |
...
|--------|-------|
| Total MMD | 0.168294 |
| σ component | 0.040913 |
| μ component | 0.127381 |
...
| Mean |Z| | 1.623479e+00 |
| Std |Z| | 1.854946e+00 |
| Impedance real range | [-3.193453e+00, 1.778066e+00] |
| Impedance imag range | [-7.174394e+00, 2.882593e-01] |
| Reference |Z| (real data) | 3.324762e-01 |
| Amplitude relative error | 3.8830 (388.30%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.015712 | 0.116728 |
| 0.050 | 0.075632 | 0.533530 |
| 0.100 | 0.159323 | 0.890711 |
| 0.200 | 0.299852 | 1.316202 |
| 0.500 | 0.615044 | 2.241430 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 2.3589 |
