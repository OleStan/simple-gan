...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.034121 |
| Mean relative difference | 0.0963 (9.63%) |
| Variance ratio (gen/real) | 1.3307 |
| Variance absolute difference | 0.005692 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.042906 |
| σ dimensions mean | 0.047917 |
| μ dimensions mean | 0.037895 |
...
|--------|-------|
| Total MMD | 0.236907 |
| σ component | 0.114492 |
| μ component | 0.122415 |
...
| Mean |Z| | 2.190048e+00 |
| Std |Z| | 4.358115e-01 |
| Impedance real range | [-3.515786e+00, -5.970006e-01] |
| Impedance imag range | [-8.749605e-02, 2.293234e+00] |
| Reference |Z| (real data) | 3.324762e-01 |
| Amplitude relative error | 5.5871 (558.71%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.012179 | 0.031362 |
| 0.050 | 0.059931 | 0.176359 |
| 0.100 | 0.119384 | 0.435395 |
| 0.200 | 0.245254 | 0.907431 |
| 0.500 | 0.681201 | 1.881976 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 0.5520 |
