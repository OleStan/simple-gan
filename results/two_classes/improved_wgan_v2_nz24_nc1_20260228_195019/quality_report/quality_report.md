...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.070865 |
| Mean relative difference | 0.1973 (19.73%) |
| Variance ratio (gen/real) | 1.1872 |
| Variance absolute difference | 0.005060 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.076398 |
| σ dimensions mean | 0.081934 |
| μ dimensions mean | 0.070863 |
...
|--------|-------|
| Total MMD | 0.729462 |
| σ component | 0.363071 |
| μ component | 0.366392 |
...
| Mean |Z| | 1.818347e+00 |
| Std |Z| | 1.101647e+00 |
| Impedance real range | [-3.994019e+00, 6.157174e-02] |
| Impedance imag range | [-2.236550e+00, 1.346735e+00] |
| Reference |Z| (real data) | 3.324762e-01 |
| Amplitude relative error | 4.4691 (446.91%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.011762 | 0.042770 |
| 0.050 | 0.059360 | 0.169132 |
| 0.100 | 0.115890 | 0.349474 |
| 0.200 | 0.232599 | 0.603201 |
| 0.500 | 0.613579 | 1.557880 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 0.5178 |
