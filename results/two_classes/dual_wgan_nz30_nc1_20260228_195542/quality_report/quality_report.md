...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.014966 |
| Mean relative difference | 0.1324 (13.24%) |
| Variance ratio (gen/real) | 1.0558 |
| Variance absolute difference | 0.008154 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.049205 |
| σ dimensions mean | 0.048060 |
| μ dimensions mean | 0.050350 |
...
|--------|-------|
| Total MMD | 0.353022 |
| σ component | 0.103370 |
| μ component | 0.249653 |
...
| Mean |Z| | 2.144535e+00 |
| Std |Z| | 5.458902e-01 |
| Impedance real range | [-4.238517e-01, 4.135436e-01] |
| Impedance imag range | [-2.405129e+00, 3.448681e+00] |
| Reference |Z| (real data) | 3.324762e-01 |
| Amplitude relative error | 5.4502 (545.02%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.019712 | 0.358502 |
| 0.050 | 0.087180 | 1.197386 |
| 0.100 | 0.165994 | 1.193908 |
| 0.200 | 0.305868 | 1.295580 |
| 0.500 | 0.570397 | 1.967193 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 2.1471 |
