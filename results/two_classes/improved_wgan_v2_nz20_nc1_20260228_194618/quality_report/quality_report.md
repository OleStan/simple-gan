...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.037881 |
| Mean relative difference | 0.0857 (8.57%) |
| Variance ratio (gen/real) | 0.9922 |
| Variance absolute difference | 0.004411 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.046252 |
| σ dimensions mean | 0.056027 |
| μ dimensions mean | 0.036477 |
...
|--------|-------|
| Total MMD | 0.282121 |
| σ component | 0.136431 |
| μ component | 0.145690 |
...
| Mean |Z| | 3.173542e+00 |
| Std |Z| | 1.816508e-01 |
| Impedance real range | [-1.750083e+00, -3.930398e-01] |
| Impedance imag range | [2.479691e+00, 3.470232e+00] |
| Reference |Z| (real data) | 3.324762e-01 |
| Amplitude relative error | 8.5452 (854.52%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.012067 | 0.040138 |
| 0.050 | 0.061129 | 0.153010 |
| 0.100 | 0.125248 | 0.436318 |
| 0.200 | 0.254219 | 0.728452 |
| 0.500 | 0.692269 | 1.955537 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 0.6483 |
