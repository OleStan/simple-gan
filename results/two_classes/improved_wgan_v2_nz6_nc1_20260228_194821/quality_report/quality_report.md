...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.031056 |
| Mean relative difference | 0.0731 (7.31%) |
| Variance ratio (gen/real) | 0.6288 |
| Variance absolute difference | 0.003441 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.038927 |
| σ dimensions mean | 0.046791 |
| μ dimensions mean | 0.031062 |
...
|--------|-------|
| Total MMD | 0.306686 |
| σ component | 0.132125 |
| μ component | 0.174562 |
...
| Mean |Z| | 1.910753e+00 |
| Std |Z| | 5.548802e-01 |
| Impedance real range | [-2.462018e+00, 8.862851e-02] |
| Impedance imag range | [-2.784769e+00, 2.543812e+00] |
| Reference |Z| (real data) | 3.324762e-01 |
| Amplitude relative error | 4.7470 (474.70%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.011425 | 0.042198 |
| 0.050 | 0.056345 | 0.228495 |
| 0.100 | 0.107993 | 0.595917 |
| 0.200 | 0.220303 | 0.955536 |
| 0.500 | 0.485087 | 1.979871 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 1.1414 |
