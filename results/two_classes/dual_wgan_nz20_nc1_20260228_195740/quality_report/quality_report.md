...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.022518 |
| Mean relative difference | 0.1631 (16.31%) |
| Variance ratio (gen/real) | 0.6220 |
| Variance absolute difference | 0.008115 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.061409 |
| σ dimensions mean | 0.069448 |
| μ dimensions mean | 0.053369 |
...
|--------|-------|
| Total MMD | 0.638672 |
| σ component | 0.260810 |
| μ component | 0.377862 |
...
| Mean |Z| | 3.329883e+00 |
| Std |Z| | 1.331797e+00 |
| Impedance real range | [-2.366712e+00, 6.663414e-01] |
| Impedance imag range | [-3.600383e+00, 5.679410e+00] |
| Reference |Z| (real data) | 3.324762e-01 |
| Amplitude relative error | 9.0154 (901.54%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.011063 | 0.425067 |
| 0.050 | 0.039484 | 0.798705 |
| 0.100 | 0.067707 | 0.922246 |
| 0.200 | 0.124109 | 0.918822 |
| 0.500 | 0.244477 | 0.974917 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 2.0296 |
