...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.030576 |
| Mean relative difference | 0.4443 (44.43%) |
| Variance ratio (gen/real) | 1.1772 |
| Variance absolute difference | 0.027046 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.056029 |
| σ dimensions mean | 0.057221 |
| μ dimensions mean | 0.054836 |
...
|--------|-------|
| Total MMD | 0.012758 |
| σ component | 0.007285 |
| μ component | 0.005473 |
...
| Mean |Z| | 4.013185e+01 |
| Std |Z| | 1.741531e+01 |
| Impedance real range | [-3.158312e+00, 3.081806e+01] |
| Impedance imag range | [5.972576e+00, 5.221773e+01] |
| Reference |Z| (real data) | 2.311503e+01 |
| Amplitude relative error | 0.7362 (73.62%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.000983 | 0.006519 |
| 0.050 | 0.003008 | 0.014054 |
| 0.100 | 0.008029 | 0.048142 |
| 0.200 | 0.014831 | 0.073640 |
| 0.500 | 0.028581 | 0.170719 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 0.0492 |
