...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.009990 |
| Mean relative difference | 0.0261 (2.61%) |
| Variance ratio (gen/real) | 0.9685 |
| Variance absolute difference | 0.001445 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.013725 |
| σ dimensions mean | 0.015336 |
| μ dimensions mean | 0.012115 |
...
|--------|-------|
| Total MMD | 0.025740 |
| σ component | 0.010469 |
| μ component | 0.015271 |
...
| Mean |Z| | 4.246820e-01 |
| Std |Z| | 2.582082e-01 |
| Impedance real range | [-3.297819e-01, 6.564053e-03] |
| Impedance imag range | [-8.746574e-01, 4.438705e-01] |
| Reference |Z| (real data) | 3.324762e-01 |
| Amplitude relative error | 0.2773 (27.73%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.008035 | 0.035712 |
| 0.050 | 0.039499 | 0.183797 |
| 0.100 | 0.079465 | 0.359581 |
| 0.200 | 0.158281 | 0.780253 |
| 0.500 | 0.382452 | 1.451632 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 0.9598 |
