...
| Metric | Value |
|--------|-------|
| Mean absolute difference | 0.016540 |
| Mean relative difference | 0.0757 (7.57%) |
| Variance ratio (gen/real) | 1.0114 |
| Variance absolute difference | 0.001716 |
...
| Metric | Value |
|--------|-------|
| Mean Wasserstein distance | 0.020055 |
| σ dimensions mean | 0.010999 |
| μ dimensions mean | 0.029110 |
...
|--------|-------|
| Total MMD | 0.104868 |
| σ component | 0.004368 |
| μ component | 0.100500 |
...
| Mean |Z| | 8.890810e-01 |
| Std |Z| | 8.901781e-01 |
| Impedance real range | [-7.319108e-01, 1.704852e-01] |
| Impedance imag range | [-3.411848e+00, 5.589931e-02] |
| Reference |Z| (real data) | 3.324762e-01 |
| Amplitude relative error | 1.6741 (167.41%) |
...
|-----------------|---------------|--------------|
| 0.010 | 0.009461 | 0.042874 |
| 0.050 | 0.046983 | 0.214485 |
| 0.100 | 0.094293 | 0.378977 |
| 0.200 | 0.175900 | 0.761126 |
| 0.500 | 0.435273 | 1.566984 |

| Metric | Value |
|--------|-------|
| Mean Lipschitz estimate | 0.8669 |
