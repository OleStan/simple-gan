...
def generate_samples(netG, n_samples, nz, device, norm_params, K):
    ...
    return sigma_denorm, mu_denorm, fake_data_np


def plot_sample_profiles(sigma_samples, mu_samples, n_display=16, save_path=None):
